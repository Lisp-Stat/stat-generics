...
The Lisp-Stat project has strict rules for AI usage:
...
These rules apply only to outside contributions to Lisp-Stat. Maintainers
...
Please remember that Lisp-Stat is maintained by humans.
...
AI _can_ be a productive tool in development workflow. As a project, we welcome
AI as a tool.
...
This policy was taken from ghostty's version.
